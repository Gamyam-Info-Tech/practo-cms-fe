...
export const DUMMY_NOTIFICATION_LIST_RESPONSE = {
  notifications: [
    {
      id: "notif-1",
      userId: "user-1",
      ...
      message:
        "Your script for 'Diabetes Management' has been approved and is ready for video creation.",
      isRead: false,
      readAt: null,
      metadata: {
        scriptId: "script-1",
    ...
    },
    {
      ...
      message:
        "Your video for 'Heart Health' has been submitted for review.",
      isRead: true,
      readAt: "2024-01-14T11:00:00.000Z",
      metadata: {
        videoId: "video-1",
...
export const DUMMY_UNREAD_COUNT_RESPONSE = {
  count: 1,
};


export const DUMMY_MARK_READ_RESPONSE = {
  id: "notif-1",
  isRead: true,
  readAt: "2024-01-15T11:00:00.000Z",
};

export const DUMMY_MARK_ALL_READ_RESPONSE = {
  updatedCount: 1,
};
